...
$(document).on('click', '.btnAddEdit', function () {
    ...
    window.location.href = "/Admin/invoice/insertupdatesalereturn/?id=" + id + "&type=addedit";
...
$(document).on('click', '.DeleteRecord', function () {
    var id = $(this).attr("data-value");
    $('#DeleteModalTitle').html("Delete Sale Return Invoice");
    $('#DeleteModalBody').html("Are you sure you want to delete this Sale Return Invoice?");
